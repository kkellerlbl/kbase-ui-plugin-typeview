...
function NarrativeMethodStore(url, auth, auth_cb) {
    ...
    this.validate_method = function (params, _callback, _errorCallback) {
    return json_call_ajax("NarrativeMethodStore.validate_method",
        [params], 1, _callback, _errorCallback);
};

    this.validate_method_async = function (params, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("NarrativeMethodStore.validate_method", [params], 1, _callback, _error_callback);
    };

    this.validate_app = function (params, _callback, _errorCallback) {
    return json_call_ajax("NarrativeMethodStore.validate_app",
        [params], 1, _callback, _errorCallback);
};

    this.validate_app_async = function (params, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("NarrativeMethodStore.validate_app", [params], 1, _callback, _error_callback);
    };

    this.validate_type = function (params, _callback, _errorCallback) {
    return json_call_ajax("NarrativeMethodStore.validate_type",
        [params], 1, _callback, _errorCallback);
};

    this.validate_type_async = function (params, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("NarrativeMethodStore.validate_type", [params], 1, _callback, _error_callback);
    };

    this.load_widget_java_script = function (params, _callback, _errorCallback) {
    return json_call_ajax("NarrativeMethodStore.load_widget_java_script",
        [params], 1, _callback, _errorCallback);
};

    this.load_widget_java_script_async = function (params, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("NarrativeMethodStore.load_widget_java_script", [params], 1, _callback, _error_callback);
    };

    this.register_repo = function (params, _callback, _errorCallback) {
    return json_call_ajax("NarrativeMethodStore.register_repo",
        [params], 0, _callback, _errorCallback);
};

    this.register_repo_async = function (params, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("NarrativeMethodStore.register_repo", [params], 0, _callback, _error_callback);
    };

    this.disable_repo = function (params, _callback, _errorCallback) {
    return json_call_ajax("NarrativeMethodStore.disable_repo",
        [params], 0, _callback, _errorCallback);
};

    this.disable_repo_async = function (params, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("NarrativeMethodStore.disable_repo", [params], 0, _callback, _error_callback);
    };

    this.push_repo_to_tag = function (params, _callback, _errorCallback) {
    return json_call_ajax("NarrativeMethodStore.push_repo_to_tag",
        [params], 0, _callback, _errorCallback);
};

    this.push_repo_to_tag_async = function (params, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("NarrativeMethodStore.push_repo_to_tag", [params], 0, _callback, _error_callback);
    };
