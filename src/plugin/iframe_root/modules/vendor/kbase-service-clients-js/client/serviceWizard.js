...
function ServiceWizard(url, auth, auth_cb, timeout, async_job_check_time_ms, async_version) {
    var self = this;
    ...
    this._check_job = function (job_id, _callback, _errorCallback) {
     ...
     this.list_service_status = function (params, _callback, _errorCallback) {
        ...
        if (typeof arguments === 'function' && arguments.length > 1+2)
            throw 'Too many arguments ('+arguments.length+' instead of '+(1+2)+')';
        return json_call_ajax("ServiceWizard.list_service_status",
            [params], 1, _callback, _errorCallback);
    };
 
     this.get_service_status = function (service, _callback, _errorCallback) {
        if (typeof service === 'function')
            throw 'Argument service can not be a function';
        if (_callback && typeof _callback !== 'function')
            throw 'Argument _callback must be a function if defined';
